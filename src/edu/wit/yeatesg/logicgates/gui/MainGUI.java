...
public class MainGUI extends Application {
    ...
    private void initLeftOfDivider() {
      ...
      //  leftOfDivider.getChildren().add(buttonBorderPane);
        ...
        TreeItem<String> wiringItem = new CircuitTreeItem("Wiring");
        ...
        EntityTreeItem outputBlockItem = new EntityTreeItem(new OutputBlock(o, 90), "Output Pin");
        ...
        treeView.getSelectionModel().selectedItemProperty().addListener((treeView, selectedBefore, nowSelected) -> {
            if (nowSelected instanceof MyTreeItem)
                ((MyTreeItem) nowSelected).onClick();
        });

        // Property table
        propertiesGoHere = new BorderPane();

        propertiesGoHere.setCenter(new Label("Item Properties and stuff go here"));
    ...
    private static abstract class MyTreeItem extends TreeItem<String> {
        public MyTreeItem(String string) {
            super(string);
        }
    ...
    public static class CircuitTreeItem extends MyTreeItem {

        public CircuitTreeItem(String string) {
            super(string);
        }

        @Override
        public void onClick() {
            // TODO implement switching between current circuits
        }
    }

    public class EntityTreeItem extends MyTreeItem {
    ...
    public void setCurrentProject(Project p) {
        ...
        currProject.getCurrentCircuit().setXOffset((int) (editorPanel.getWidth() / 2));
        currProject.getCurrentCircuit().setYOffset((int) editorPanel.getHeight() / 2);
    }
