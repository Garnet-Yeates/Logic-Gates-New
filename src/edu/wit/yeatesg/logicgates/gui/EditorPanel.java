...
public class EditorPanel extends StackPane {
    ...
    public Entity lastMessedUpOperand;
    private int messedUpDrawState = -1;

    private Timer blinkTimer = new Timer(500, (e -> { messedUpDrawState *= -1; repaint(); }));
    {
        blinkTimer.start();
    }
    ...
    public class PlaceableEntityList {
        ...
        public boolean place(CircuitPoint location, boolean preview) {
            ...
            if (preview)
                ...
                cancel(); // We are done with this PlaceableEntityList now
            }
            return true;
        }
    }
    ...
    public void repaint() {
        ...
        Platform.runLater(() -> {
            ...
            try {
                ...
                if (messedUpDrawState == 1 && lastMessedUpOperand != null)
                    lastMessedUpOperand.draw(gc, Color.PINK, 0.75);
            }
            catch (Exception e) {
                e.printStackTrace();
            }
